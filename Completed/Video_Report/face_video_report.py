...
class face_video:
    ...
    def __initalize_argument_parser():
        ...
        parser.add_argument('-s', '--startTime', type=str, help='Add the end search time in yyyy-mm-dd~(0)0:00:00 or default to 30 minuntes before current time')
    ...
    def recent_faces(self):
        ...
        #checks to see if the user put in a start and end time if not it defaults to 30 minutes before current
    ...
    def execute(self):
        ...
        self.header = ['Name', 'Date', 'Camera', 'Video File Name']
        self.csv_data = []
